...
`  ╔══════════════════════════════════╗
  ...
  ╚══════════════════════════════════╝`
      ...
      <style>{`
        ...
        .it-title{ font-family: var(--ff-it-mono); font-size: clamp(48px, 9vw, 140px); line-height: 1; font-weight: 400; letter-spacing: .02em; color: var(--accent); text-shadow: 0 0 12px rgba(51,255,51,.4); margin-bottom: 56px; text-transform: lowercase;}
        ...
        .it-cols{ display:grid; grid-template-columns: repeat(3, 1fr); gap: 32px; font-family: var(--ff-it-mono); font-size: 16px; margin-bottom: 48px;}
        ...
        @media (max-width: 800px){ .it-cols{ grid-template-columns: 1fr; gap: 16px;} .it-ascii{ font-size: 10px;}}
      `}</style>
    </section>
  );
}
